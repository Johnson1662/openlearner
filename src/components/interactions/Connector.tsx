...
export default function Connector({
  ...
  return (
    <div className="w-full">
      <div
        ref={containerRef}
        className="relative bg-gradient-to-br from-muted to-duo-gray/30 rounded-2xl overflow-hidden"
        style={{ minHeight: 400 }}
      ...
      <p className="mt-4 text-sm text-duo-textMuted text-center">
  ...
  return (
    ...
    >
      <motion.div
        className={`
          ...
          ${isActive 
            ...
            : isConnected
              ? 'bg-duo-greenLight text-duo-greenDark border-2 border-duo-green/50'
              : 'bg-background text-duo-text border-2 border-duo-gray hover:border-primary/50'
          }
        `}
      ...
      <motion.div
        ...
        style={{
          backgroundColor: isActive ? '#8257E5' : isConnected ? '#58CC02' : '#E5E5E5'
        }}
  ...
  return (
    ...
    >
      <motion.path
        d={path}
        fill="none"
        stroke={isCorrect ? '#58CC02' : '#8257E5'}
        strokeWidth="3"
        strokeLinecap="round"
...
function ElasticLine({
  ...
  return (
    <motion.path
      d={path}
      fill="none"
      stroke={isPreview ? '#AFAFAF' : '#8257E5'}
      strokeWidth="2"
