...
export const presetAnimations: PresetAnimation[] = [
  ...
  <circle cx="100" cy="100" r="30" fill="none" stroke="#8257E5" stroke-width="3">
    <animate attributeName="r" values="30;60;30" dur="2s" repeatCount="indefinite"/>
    <animate attributeName="opacity" values="1;0.3;1" dur="2s" repeatCount="indefinite"/>
  </circle>
  <circle cx="100" cy="100" r="15" fill="#8257E5"/>
</svg>`,
  },
  {
    name: 'wave-animation',
  ...
  <path fill="none" stroke="#1CB0F6" stroke-width="3" stroke-linecap="round">
  ...
  <circle cx="50" cy="50" r="40" fill="none" stroke="#8257E5" stroke-width="6" stroke-linecap="round" stroke-dasharray="180" stroke-dashoffset="60">
  ...
  <circle cx="0" cy="40" r="4" fill="#8257E5" opacity="0">
  ...
  <rect x="0" y="25" width="80" height="10" rx="5" fill="#8257E5">
  ...
  <circle cx="50" cy="100" r="8" fill="#8257E5"/>
  <circle cx="150" cy="50" r="8" fill="#8b5cf6"/>
  <circle cx="150" cy="100" r="8" fill="#8b5cf6"/>
  <circle cx="150" cy="150" r="8" fill="#8b5cf6"/>
  <circle cx="250" cy="100" r="8" fill="#FF4B4B"/>
  <line x1="50" y1="100" x2="150" y2="50" stroke="#8257E5" stroke-width="2" opacity="0.5">
    <animate attributeName="opacity" values="0.2;0.8;0.2" dur="2s" repeatCount="indefinite"/>
  </line>
  <line x1="50" y1="100" x2="150" y2="100" stroke="#8257E5" stroke-width="2" opacity="0.5">
    <animate attributeName="opacity" values="0.2;0.8;0.2" dur="2s" begin="0.3s" repeatCount="indefinite"/>
  </line>
  <line x1="50" y1="100" x2="150" y2="150" stroke="#8257E5" stroke-width="2" opacity="0.5">
  ...
  <circle cx="50" cy="100" r="12" fill="none" stroke="#8257E5" stroke-width="2" opacity="0">
  ...
  <line x1="75" y1="75" x2="75" y2="35" stroke="#8257E5" stroke-width="3" stroke-linecap="round">
  ...
  <line x1="100" y1="100" x2="180" y2="100" stroke="#8257E5" stroke-width="2">
    <animateTransform attributeName="transform" type="rotate" from="0 100 100" to="360 100 100" dur="3s" repeatCount="indefinite"/>
  </line>
  <polygon points="100,100 180,90 180,110" fill="#8257E5" opacity="0.3">
    <animateTransform attributeName="transform" type="rotate" from="0 100 100" to="360 100 100" dur="3s" repeatCount="indefinite"/>
  </polygon>
</svg>`,
  },
  {
    ...
    height: 200,
    svg: `<svg width="200" height="200" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
  <circle cx="100" cy="100" r="10" fill="none" stroke="#8257E5" stroke-width="2">
