...
-- Course requirements table (stores user preferences for course generation)
CREATE TABLE IF NOT EXISTS course_requirements (
  course_id TEXT PRIMARY KEY,
  subject TEXT,
  prior_knowledge TEXT DEFAULT 'intermediate',
  learning_goal TEXT DEFAULT 'professional',
  learning_pacing TEXT DEFAULT 'balanced',
  material_source_type TEXT DEFAULT 'paste',
  created_at TEXT NOT NULL,
  FOREIGN KEY (course_id) REFERENCES courses(id) ON DELETE CASCADE
);
